...
// NAMESPACE OBJECT: ./src/app/api/users/unfollow/route.ts
...
;// ./src/app/api/users/unfollow/route.ts
...
async function POST(request) {
    try {
        ...
        const { error } = await supabase.from("followers").delete().eq("follower_id", userId).eq("following_id", followingId);
        if (error) {
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/users/unfollow/route",
        pathname: "/api/users/unfollow",
        filename: "route",
        bundlePath: "app/api/users/unfollow/route"
    },
    resolvedPagePath: "D:\\the360unity-master\\the360unity-master\\src\\app\\api\\users\\unfollow\\route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [4447,2190,7296,8443,9398], () => (__webpack_exec__(9224)));
