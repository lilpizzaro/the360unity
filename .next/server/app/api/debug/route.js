...
// NAMESPACE OBJECT: ./src/app/api/debug/route.ts
...
async function GET() {
    try {
        ...
        const envVars = {
            NEXT_PUBLIC_SUPABASE_URL:  true ? 'Set' : 0,
            NEXT_PUBLIC_SUPABASE_ANON_KEY:  true ? 'Set' : 0,
        ...
        try {
            ...
            const { data, error: queryError } = await supabase/* supabase */.ND.from('projects').select('id').limit(1);
            if (queryError) {
        ...
        return server.NextResponse.json({
            ...
            supabase: {
                ...
                hasRealtime: Boolean(supabase/* supabase */.ND.realtime)
            }
        });
    } catch (error) {
        return server.NextResponse.json({
...
;// ./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fdebug%2Froute&name=app%2Fapi%2Fdebug%2Froute&pagePath=private-next-app-dir%2Fapi%2Fdebug%2Froute.ts&appDir=D%3A%5Cthe360unity-master%5Cthe360unity-master%5Csrc%5Capp&appPaths=%2Fapi%2Fdebug%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "D:\\the360unity-master\\the360unity-master\\src\\app\\api\\debug\\route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [4447,2190,9398], () => (__webpack_exec__(20004)));
