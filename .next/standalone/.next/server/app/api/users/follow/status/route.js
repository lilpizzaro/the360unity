...
// NAMESPACE OBJECT: ./src/app/api/users/follow/status/route.ts
...
async function GET(request) {
    try {
        ...
        const { data, error, count } = await supabase.from("followers").select("*", {
            count: "exact"
        }).eq("follower_id", userId).eq("following_id", followingId).limit(1);
        if (error) {
...
;// ./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fusers%2Ffollow%2Fstatus%2Froute&name=app%2Fapi%2Fusers%2Ffollow%2Fstatus%2Froute&pagePath=private-next-app-dir%2Fapi%2Fusers%2Ffollow%2Fstatus%2Froute.ts&appDir=D%3A%5Cthe360unity-master%5Cthe360unity-master%5Csrc%5Capp&appPaths=%2Fapi%2Fusers%2Ffollow%2Fstatus%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/users/follow/status/route",
        pathname: "/api/users/follow/status",
        filename: "route",
        bundlePath: "app/api/users/follow/status/route"
    },
    resolvedPagePath: "D:\\the360unity-master\\the360unity-master\\src\\app\\api\\users\\follow\\status\\route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [4447,2190,7296,8443,9398], () => (__webpack_exec__(21321)));
