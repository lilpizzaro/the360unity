...
// NAMESPACE OBJECT: ./src/app/api/forum/comments/route.ts
...
async function GET(request) {
    ...
    try {
        const { data, error } = await supabase/* supabase */.ND.from('forum_comments').select('*').eq('post_id', postId).order('created_at', {
            ascending: true
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data: newComment, error } = await supabase/* supabase */.ND.from('forum_comments').insert(commentData).select().single();
        if (error) {
        ...
        await supabase/* supabase */.ND.from('forum_posts').update({
        ...
        return server.NextResponse.json(transformedComment);
    } catch (error) {
...
;// ./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?page=%2Fapi%2Fforum%2Fcomments%2Froute&name=app%2Fapi%2Fforum%2Fcomments%2Froute&pagePath=private-next-app-dir%2Fapi%2Fforum%2Fcomments%2Froute.ts&appDir=D%3A%5Cthe360unity-master%5Cthe360unity-master%5Csrc%5Capp&appPaths=%2Fapi%2Fforum%2Fcomments%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=standalone&nextConfigExperimentalUseEarlyImport=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/forum/comments/route",
        pathname: "/api/forum/comments",
        filename: "route",
        bundlePath: "app/api/forum/comments/route"
    },
    resolvedPagePath: "D:\\the360unity-master\\the360unity-master\\src\\app\\api\\forum\\comments\\route.ts",
    nextConfigOutput,
...
var __webpack_exports__ = __webpack_require__.X(0, [4447,2190,7296,8443,9398], () => (__webpack_exec__(84654)));
